        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">{{ $product->product }} </h1>
                            ...
                            <i class="fa fa-star text-secondary"></i> --}}
                                <span class="list-inline-item text-dark">Rating:{{$rating}}||Comment:{{$comments}}</span>
                            </p>
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>{{ $product->category->category_name }}</strong></p>
                                </li>
                            </ul>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                       <a href="{{route('mail',["id"=>$product->id])}}" ><input type="button" class="btn btn-success btn-lg" name="submit"
                                            value="buy"></a>
                                    </div>
                                    <!-- Review Button (Existing) -->
                                    <div class="col d-grid">
                            ...
                            <div id="review-form" style="display: block; margin-top: 20px;">
                                ...
                                <form action="{{ route('review') }}" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-success mt-2" value="Review">
                                </form>
                            </div>
